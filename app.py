...
class Application:
    ...
    def action_call(self) :
        ...
        self.tx6.config(text = "Karandeep Singh \n 2004608", font = ("Courier",15,"bold"))
        ...
        self.tx2.config(text = "Manav Loona \n2004620", font = ("Courier",15,"bold"))
        ...
        self.tx3.config(text = "Manjot Singh Bhatia\n2004622", font = ("Courier",15,"bold"))
        
        self.tx7 = tk.Label(self.root1)
        self.tx7.place(x = 170,y = 360)
        self.tx7.config(text = "Under the supervision of", fg="red", font = ("Courier",25,"bold"))
